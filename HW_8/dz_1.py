...
def dir_walker(aim_path: str, total_dct: dict = None) -> dict[str, dict[str]]:
    if total_dct is None:
        total_dct = {}
        basic_path = os.path.split(os.path.abspath(aim_path))                                           #('C:\\Users\\user\\PycharmProjects\\pythonProject\\GEEK\\Dipping_python\\Homeworks\\HW_8\\seminar_8')
...
def main():
    ...
    #tst_path = '\\Users\\user\\PycharmProjects\\pythonProject\\GEEK\\Dipping_python\\Homeworks\\HW_8\\seminar_8\\'
